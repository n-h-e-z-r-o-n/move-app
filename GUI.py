...
def Home_Page(widget):
    ...
    while row < 3:  # 3
        while column < 8:  # 8
            ...
            r1_bt1 = tk.Label(label1, bg='#1A2421', borderwidth=0, justify=tk.CENTER, activebackground=hover_color, border=0)
            r1_bt1.place(relx=0, rely=0, relwidth=1, relheight=1)
            change_bg_OnHover(r1_bt1, hover_color, '#1A2421')
            r1_bt2 = tk.Label(label1, borderwidth=0, border=0, bg=recomendation_tubs_bg_color, activeforeground=hover_color, activebackground=recomendation_tubs_bg_color, fg='gray', font=('Calibri', 11))  # , command=lambda id=populer_movie_list[track]: selected_movie_detail(id))
            r1_bt2.place(relx=0, rely=0.9, relwidth=1, relheight=0.1)
            change_fg_OnHover(r1_bt2, hover_color, 'gray')
    ...
    while row < 3:  # 3 rows
        while column < 8:  # 8 columns
            ...
            r1_bt3 = tk.Label(label3, bg='#1A2421', borderwidth=0, justify=tk.CENTER, activebackground=hover_color, border=0)  # , command=lambda id = populer_series_list[track][3]: selected_movie_detail(id))
            r1_bt3.place(relx=0, rely=0, relwidth=1, relheight=1)
            change_bg_OnHover(r1_bt3, hover_color, '#1A2421')
            r1_bt4 = tk.Label(label3, borderwidth=0, border=0, bg=recomendation_tubs_bg_color, text='', activeforeground=hover_color, activebackground='#1A2421', fg='gray', font=('Calibri', 11))  # , command=lambda id= populer_movie_list[track]: selected_movie_detail(id))
